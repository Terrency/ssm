...
<div class="container-fluid">
    ...
    <form id="form" class="form-horizontal form-group-sm" role="form">
        ...
        <div class="form-group">
            ...
            <div class="col-sm-8">
                <input id="name" name="name" value="${permission.name}" type="text" class="form-control" placeholder="资源名称"
        ...
        <div class="form-group">
            ...
            <div class="col-sm-8">
                <input id="code" name="code" value="${permission.code}" type="text" class="form-control"
        ...
        <div class="form-group">
            ...
            <div class="col-sm-8">
                <input id="url" name="url" value="${permission.url}" type="text" class="form-control" placeholder="资源地址">
            </div>
        </div>
        <div class="form-group">
            ...
            <div class="col-sm-8">
                <select id="type" name="type" class="form-control" data-provide="select2" data-bv-notempty="true">
                    <option value="FUNC" ${permission.type=='FUNC'?'selected':null}>功能</option>
                    <option value="MENU" ${permission.type=='MENU'?'selected':null}>菜单</option>
                </select>
            </div>
        </div>
        <div class="form-group">
            ...
            <div class="col-sm-8">
                <select id="status" name="status" class="form-control" data-provide="select2" data-bv-notempty="true">
                    <option value="1" ${permission.status==1?'selected':null}>可用</option>
                    <option value="0" ${permission.status==0?'selected':null}>不可用</option>
                </select>
            </div>
        </div>
        <div class="form-group">
            ...
            <div class="col-sm-8">
                <input id="seq" name="seq" value="${permission.seq}" type="number" class="form-control" placeholder="排序号"
                       data-bv-notempty="true">
            </div>
        </div>
        <div class="form-group">
            ...
            <div class="col-sm-8">
                <input id="icon" name="icon" value="${permission.icon}" type="text" class="form-control" placeholder="资源图标">
            </div>
        </div>
        <div class="form-group">
            <label class="control-label col-sm-2" for="parentId">上级资源</label>
            <div class="col-sm-8">
                <input id="parentId" value="${permission.parentName}" type="text" class="form-control"
    ...
    require([
        ...
        var setting = {
            ...
            async: {
                ...
                dataFilter: function (treeId, parentNode, responseData) {
                    return $.grep(responseData, function (obj, idx) {
                        return obj.type === 'MENU' && obj.id != '${permission.id}' && obj.parentId != '${permission.id}';
                    });
                }
            },
            data: {
            ...
            callback: {
                ...
                onAsyncSuccess: function (e, treeId, treeNode, msg) {
                    ...
                    var defaultCheckNode = zTree.getNodeByParam('id', '${permission.parentId}');
        ...
        $('#btnSave').click(function () {
            ...
            if ($form.validate()) {
                ...
                $.ajax({
                    url: '${contextPath}/permission/editSubmit',
                    type: 'POST',
